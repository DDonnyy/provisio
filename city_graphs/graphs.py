...
from city_graphs.osm_worker import overpass_query, get_boundary, get_routes
from city_graphs.utils import (
...
def get_intermodal_graph(
    ...
    G_public_transport: nx.MultiDiGraph = get_public_trasport_graph(
        city_osm_id, city_crs, gdf_files, public_transport_speeds
    )
    G_walk: nx.MultiDiGraph = get_osmnx_graph(
        city_osm_id, city_crs, "walk", speed=walk_speed
    )

    G_drive: nx.MultiDiGraph = get_osmnx_graph(
        city_osm_id, city_crs, "drive", speed=drive_speed
    )
